...
public class IC_Card_Pos_Activity extends Activity {

	private LocationManager mLocationManager;
	private LocationListener mListener;
	private TextView mtv;

	ArrayList<ArrayList<IC_Card_Pos_bean_item>> getBikeBeanList;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_search_bic_card_pos);
	...
	protected void getDataFromServer(double latitude,double longitude) {
    	...
    	// {"cmd":"getIcRecharge","params":{"lng":"116.296482","lat":"40.0493","searchKey":""}}
    	
		
		send_bike_bean.cmd = "getIcRecharge";
			...
			public void onSuccess(ResponseInfo<String> string) {
				...
				//	System.out.println(get_bikebean.result.list.size());
					...
					try {
						...
						final ArrayList<IC_Card_Pos_bean_item> buslist = new ArrayList<IC_Card_Pos_bean_item>();
						for(int i = 0 ;i < data.length(); i++){
							IC_Card_Pos_bean_item getbike_bean_item =new IC_Card_Pos_bean_item();
							getbike_bean_item.icId = data.getJSONArray(i).get(0)+"";
							getbike_bean_item.name = (String) data.getJSONArray(i).get(1);
							getbike_bean_item.address = (String) data.getJSONArray(i).get(2);
							getbike_bean_item.summary = (String) data.getJSONArray(i).get(3);
							getbike_bean_item.weidu = (String) data.getJSONArray(i).get(4);
							getbike_bean_item.jingdu = (String) data.getJSONArray(i).get(5);
							getbike_bean_item.diatance = (String) data.getJSONArray(i).get(6);
						...
						new Handler().postDelayed(new Runnable() {
							...
							@Override
							public void run() {
							Intent intent = new Intent(IC_Card_Pos_Activity.this,IC_Card_Pos_view_Activity.class);
